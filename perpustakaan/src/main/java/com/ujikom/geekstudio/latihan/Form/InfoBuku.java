...
public class InfoBuku extends javax.swing.JDialog {
    ...
    public void dataDetail(int table){
        try {
            if (tabel == true){
            String a = tabelInfoBuku.getValueAt(table, 0).toString();
            String b = tabelInfoBuku.getValueAt(table, 1).toString();
            String c = tabelInfoBuku.getValueAt(table, 2).toString();
            String d = tabelInfoBuku.getValueAt(table, 3).toString();
            String e = tabelInfoBuku.getValueAt(table, 4).toString();
            String f = tabelInfoBuku.getValueAt(table, 5).toString();
            String g = tabelInfoBuku.getValueAt(table, 6).toString();
            String h = tabelInfoBuku.getValueAt(table, 7).toString();
            String i = tabelInfoBuku.getValueAt(table, 8).toString();
            String j = tabelInfoBuku.getValueAt(table, 9).toString();
            String k = tabelInfoBuku.getValueAt(table, 10).toString();
            String l = tabelInfoBuku.getValueAt(table, 11).toString();
            
            txtKdBuku.setText(a);
            cbKategori.setSelectedItem(b);
            txtKategori.setText(c);
            cbPenerbit.setSelectedItem(d);
            txtPenerbit.setText(e);
            cbPengarang.setSelectedItem(f);
            txtPengarang.setText(g);
            txtJudulBuku.setText(h);
            txtSinopsis.setText(i);
            txtJumlahBuku.setText(j);
            txtGambarBuku.setText(k);
            } else {
    ...
    //
    public InfoBuku(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        SetEditMati();
        buka_database();
    ...
    private void initComponents() {
        ...
        tabelInfoBuku = new javax.swing.JTable();
        ...
        jLabel1.setText("Info Buku Ceria Library");
        ...
        tabelInfoBuku.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tabelInfoBuku.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tabelInfoBukuMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(tabelInfoBuku);
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        ...
        tabelInfoBuku.setEnabled(false);
        Bersih();
        buatNoBuku();
        SetTombolHidup();
        SetEditHidup();
        tabelInfoBuku.isEnabled();
        edit = false;
    ...
    private void tabelInfoBukuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelInfoBukuMouseClicked
        // TODO add your handling code here:
        try {
        if (tabel == true){
            int table = tabelInfoBuku.getSelectedRow();
            String a = tabelInfoBuku.getValueAt(table, 0).toString();
            String b = tabelInfoBuku.getValueAt(table, 1).toString();
            String c = tabelInfoBuku.getValueAt(table, 2).toString();
            String d = tabelInfoBuku.getValueAt(table, 3).toString();
    ...
    }//GEN-LAST:event_tabelInfoBukuMouseClicked
    ...
    private void btnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariActionPerformed
        ...
        try {
            ...
            if (key.equalsIgnoreCase("Kode Buku")){
                sql = "select*from tr_buku where kdBuku like '%" + txtCariBuk.getText() + "%'";
            }else if (key.equalsIgnoreCase("Judul Buku")){
                sql = "select*from tr_buku where judulBuku like '%" + txtCariBuk.getText() + "%'";
            }else{
                sql = "select*from tr_buku order by kdBuku asc";
                tampildata();
            }
            rss = stm.executeQuery(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InfoBuku.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InfoBuku dialog = new InfoBuku(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable tabelInfoBuku;
